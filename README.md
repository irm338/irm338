...
| :--- | :--- | :--- | :---: |
| **CampusShop** | Maquetación estática de plataforma e-commerce. | HTML5, CSS3 | [Ver Código](https://github.com/Irm338/Proyecto1_CampusShop) |
| **CampusParking** | Interfaz para administración de estacionamiento. | HTML5, CSS3, JS | [Ver Código](https://github.com/Irm338/Proyecto2_CampusParking) |
...
*   **📚 Educación Complementaria (Intecap y otros):**
    *   Certificación en Electrónica Industrial
    *   Curso de Intecap de Computación Básico
    *   Curso de Intecap de Comunicación Asertiva
    *   Curso de Intecap de Reparación de Electrodomésticos
